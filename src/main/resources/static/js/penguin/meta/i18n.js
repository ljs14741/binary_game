...
export const T = Object.assign({
  ...
  warn: '{0} 접근 중!',
  bossTag: '보스 등장!',
  bossHint: { bossSeal: '겨냥하면 돌진! 벽에 부딪히면 튕겨요', bossBear: '얼굴을 가리면 공격 무효 · 날아오는 얼음은 톡!', bossOrca: '잠수 중엔 공격 무효 · 반피가 되면 부하를 불러요' },
  bossState: { stun: '기절!', guard: '막는 중', dive: '잠수 중', rage: '화났다!', dash: '돌진!' },
  predNames: { skua: '도둑갈매기', seal: '표범물범', shark: '상어', bossSeal: '대왕 바다코끼리', bossBear: '북극곰', bossOrca: '범고래' },
  blocked: '막았다!',
  ...
  next: '다음 레벨',
  retry: '다시하기',
  guestClear: '재밌었다면 방명록에 한마디!',
  guestLose: '아쉬운 점은 방명록에 남겨주세요',
  lose: '펭귄이 모두 떠났어요…',
  ...
  predDesc: {
    ...
    seal: '펭귄 사냥꾼. 지그재그로 헤엄쳐서 맞히기 까다로워요. 여러 대 맞으면 화나서 잠깐 빨라져요.',
    shark: '펭귄 둘레를 돌다가 빨간 선으로 겨냥하고 직선으로 돌격해요. 선 위의 펭귄이 위험!',
    bossSeal: '왕관 쓴 대왕 바다코끼리. {0}초마다 겨냥해서 돌진하고, 벽에 부딪히면 튕겨 나와요.',
    bossBear: '{0}초마다 앞발로 얼굴을 가려요 (공격 무효). 얼음덩이를 던져 펭귄을 얼리니 날아오는 얼음을 톡 깨세요.',
    bossOrca: '잠수하면 공격이 안 먹히고, 떠오르며 돌진해요. 체력이 절반이 되면 표범물범 2마리를 불러요.'
  },
